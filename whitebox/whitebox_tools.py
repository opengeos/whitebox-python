        ...
        try:
            ...
            if "agri" in ext_name.lower():
                ...
                if "gte" not in ext_name.lower():
                    print(
                        f"Warning: Unrecognized extension ext_name {ext_name}. Installing the GTE instead..."
                    )
            ...
            if "agri" in ext_name.lower():
                ...
                print(
                    "The Whitebox DEM and Spatial Hydrology Toolset Extension has been installed!"
                )
            elif "lidar" in ext_name.lower():
                print(
                    "The Whitebox DEM and LiDAR and Remote Sensing Toolset Extension has been installed!"
                )
            else:
                print(
                    "The Whitebox General Toolset Extension (GTE) has been installed!"
                )
...
"""
            ...
            print(
                "Please contact support@whiteboxgeo.com if you continue to experience issues."
            )
            raise
    ...
    def add_point_coordinates_to_table(self, i, callback=None):
        ...
        return self.run_tool(
            "add_point_coordinates_to_table", args, callback
        )  # returns 1 if error
    ...
    def convert_nodata_to_zero(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "convert_nodata_to_zero", args, callback
        )  # returns 1 if error
    ...
    def convert_raster_format(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "convert_raster_format", args, callback
        )  # returns 1 if error

    def csv_points_to_vector(
        self, i, output, xfield=0, yfield=1, epsg=None, callback=None
    ):
        ...
        if epsg is not None:
            args.append("--epsg='{}'".format(epsg))
        return self.run_tool(
            "csv_points_to_vector", args, callback
        )  # returns 1 if error
    ...
    def export_table_to_csv(self, i, output, headers=True, callback=None):
        ...
        if headers:
            args.append("--headers")
        return self.run_tool(
            "export_table_to_csv", args, callback
        )  # returns 1 if error
    ...
    def merge_table_with_csv(
        self, i, pkey, csv, fkey, import_field=None, callback=None
    ):
        ...
        if import_field is not None:
            args.append("--import_field='{}'".format(import_field))
        return self.run_tool(
            "merge_table_with_csv", args, callback
        )  # returns 1 if error
    ...
    def modify_no_data_value(self, i, new_value="-32768.0", callback=None):
        ...
        return self.run_tool(
            "modify_no_data_value", args, callback
        )  # returns 1 if error
    ...
    def multi_part_to_single_part(self, i, output, exclude_holes=True, callback=None):
        ...
        args.append("--output='{}'".format(output))
        if exclude_holes:
            args.append("--exclude_holes")
        return self.run_tool(
            "multi_part_to_single_part", args, callback
        )  # returns 1 if error
    ...
    def new_raster_from_base(
        ...
        return self.run_tool(
            "new_raster_from_base", args, callback
        )  # returns 1 if error
    ...
    def print_geo_tiff_tags(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "print_geo_tiff_tags", args, callback
        )  # returns 1 if error
    ...
    def raster_to_vector_lines(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "raster_to_vector_lines", args, callback
        )  # returns 1 if error
    ...
    def raster_to_vector_points(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "raster_to_vector_points", args, callback
        )  # returns 1 if error
    ...
    def raster_to_vector_polygons(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "raster_to_vector_polygons", args, callback
        )  # returns 1 if error
    ...
    def reinitialize_attribute_table(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "reinitialize_attribute_table", args, callback
        )  # returns 1 if error
    ...
    def remove_polygon_holes(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "remove_polygon_holes", args, callback
        )  # returns 1 if error

    def remove_raster_polygon_holes(
        self, i, output, threshold=3, use_diagonals=True, callback=None
    ):
        ...
        if use_diagonals:
            args.append("--use_diagonals")
        return self.run_tool(
            "remove_raster_polygon_holes", args, callback
        )  # returns 1 if error
    ...
    def single_part_to_multi_part(self, i, output, field=None, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "single_part_to_multi_part", args, callback
        )  # returns 1 if error
    ...
    def vector_lines_to_raster(
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "vector_lines_to_raster", args, callback
        )  # returns 1 if error
    ...
    def vector_points_to_raster(
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "vector_points_to_raster", args, callback
        )  # returns 1 if error
    ...
    def vector_polygons_to_raster(
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "vector_polygons_to_raster", args, callback
        )  # returns 1 if error
    ...
    def block_maximum_gridding(
        self, i, field, output, use_z=False, cell_size=None, base=None, callback=None
    ):
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "block_maximum_gridding", args, callback
        )  # returns 1 if error

    def block_minimum_gridding(
        self, i, field, output, use_z=False, cell_size=None, base=None, callback=None
    ):
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "block_minimum_gridding", args, callback
        )  # returns 1 if error
    ...
    def construct_vector_tin(
        ...
        return self.run_tool(
            "construct_vector_tin", args, callback
        )  # returns 1 if error

    def create_hexagonal_vector_grid(
        self, i, output, width, orientation="horizontal", callback=None
    ):
        ...
        return self.run_tool(
            "create_hexagonal_vector_grid", args, callback
        )  # returns 1 if error

    def create_plane(
        self, base, output, gradient=15.0, aspect=90.0, constant=0.0, callback=None
    ):
    ...
    def create_rectangular_vector_grid(
        self, i, output, width, height, xorig=0, yorig=0, callback=None
    ):
        ...
        return self.run_tool(
            "create_rectangular_vector_grid", args, callback
        )  # returns 1 if error
    ...
    def eliminate_coincident_points(self, i, output, tolerance, callback=None):
        ...
        return self.run_tool(
            "eliminate_coincident_points", args, callback
        )  # returns 1 if error
    ...
    def extend_vector_lines(self, i, output, dist, extend="both ends", callback=None):
        ...
        return self.run_tool(
            "extend_vector_lines", args, callback
        )  # returns 1 if error
    ...
    def extract_raster_values_at_points(
        self, inputs, points, out_text=False, callback=None
    ):
        ...
        if out_text:
            args.append("--out_text")
        return self.run_tool(
            "extract_raster_values_at_points", args, callback
        )  # returns 1 if error

    def filter_raster_features_by_area(
        self, i, output, threshold, background="zero", callback=None
    ):
        ...
        return self.run_tool(
            "filter_raster_features_by_area", args, callback
        )  # returns 1 if error

    def find_lowest_or_highest_points(
        self, i, output, out_type="lowest", callback=None
    ):
        ...
        return self.run_tool(
            "find_lowest_or_highest_points", args, callback
        )  # returns 1 if error
    ...
    def heat_map(
        ...
        if weight_field is not None:
            args.append("--weight_field='{}'".format(weight_field))
        args.append("--output='{}'".format(output))
    ...
    def minimum_bounding_box(
        self, i, output, criterion="area", features=True, callback=None
    ):
        ...
        return self.run_tool(
            "minimum_bounding_box", args, callback
        )  # returns 1 if error
    ...
    def minimum_bounding_circle(self, i, output, features=True, callback=None):
        ...
        if features:
            args.append("--features")
        return self.run_tool(
            "minimum_bounding_circle", args, callback
        )  # returns 1 if error
    ...
    def minimum_bounding_envelope(self, i, output, features=True, callback=None):
        ...
        if features:
            args.append("--features")
        return self.run_tool(
            "minimum_bounding_envelope", args, callback
        )  # returns 1 if error
    ...
    def minimum_convex_hull(self, i, output, features=True, callback=None):
        ...
        if features:
            args.append("--features")
        return self.run_tool(
            "minimum_convex_hull", args, callback
        )  # returns 1 if error

    def natural_neighbour_interpolation(
        self,
        i,
        output,
        field=None,
        ...
        if clip:
            args.append("--clip")
        return self.run_tool(
            "natural_neighbour_interpolation", args, callback
        )  # returns 1 if error

    def nearest_neighbour_gridding(
        self,
        i,
        field,
        output,
        ...
        return self.run_tool(
            "nearest_neighbour_gridding", args, callback
        )  # returns 1 if error
    ...
    def radial_basis_function_interpolation(
        ...
        if base is not None:
            args.append("--base='{}'".format(base))
        return self.run_tool(
            "radial_basis_function_interpolation", args, callback
        )  # returns 1 if error
    ...
    def raster_cell_assignment(self, i, output, assign="column", callback=None):
        ...
        args.append("--assign={}".format(assign))
        return self.run_tool(
            "raster_cell_assignment", args, callback
        )  # returns 1 if error

    def raster_perimeter(
        self,
        i,
        output=None,
        out_text=False,
    ...
    def reclass(self, i, output, reclass_vals, assign_mode=False, callback=None):
        ...
        if assign_mode:
            args.append("--assign_mode")
        return self.run_tool("reclass", args, callback)  # returns 1 if error

    def reclass_equal_interval(
        self, i, output, interval=10.0, start_val=None, end_val=None, callback=None
    ):
        ...
        return self.run_tool(
            "reclass_equal_interval", args, callback
        )  # returns 1 if error
    ...
    def travelling_salesman_problem(self, i, output, duration=60, callback=None):
        ...
        return self.run_tool(
            "travelling_salesman_problem", args, callback
        )  # returns 1 if error

    def vector_hex_binning(
        self, i, output, width, orientation="horizontal", callback=None
    ):
    ...
    def cost_pathway(
        self, destination, backlink, output, zero_background=False, callback=None
    ):
    ...
    def euclidean_allocation(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "euclidean_allocation", args, callback
        )  # returns 1 if error
    ...
    def clip_raster_to_polygon(
        self, i, polygons, output, maintain_dimensions=False, callback=None
    ):
        ...
        if maintain_dimensions:
            args.append("--maintain_dimensions")
        return self.run_tool(
            "clip_raster_to_polygon", args, callback
        )  # returns 1 if error
    ...
    def erase_polygon_from_raster(self, i, polygons, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "erase_polygon_from_raster", args, callback
        )  # returns 1 if error
    ...
    def max_absolute_overlay(self, inputs, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "max_absolute_overlay", args, callback
        )  # returns 1 if error
    ...
    def merge_line_segments(self, i, output, snap=0.0, callback=None):
        ...
        args.append("--snap={}".format(snap))
        return self.run_tool(
            "merge_line_segments", args, callback
        )  # returns 1 if error
    ...
    def min_absolute_overlay(self, inputs, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "min_absolute_overlay", args, callback
        )  # returns 1 if error
    ...
    def percent_greater_than(self, inputs, comparison, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "percent_greater_than", args, callback
        )  # returns 1 if error
    ...
    def symmetrical_difference(self, i, overlay, output, snap=0.0, callback=None):
        ...
        args.append("--snap={}".format(snap))
        return self.run_tool(
            "symmetrical_difference", args, callback
        )  # returns 1 if error
    ...
    def update_nodata_cells(self, input1, input2, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "update_nodata_cells", args, callback
        )  # returns 1 if error
    ...
    def weighted_overlay(
        ...
        if constraints is not None:
            args.append("--constraints='{}'".format(constraints))
        args.append("--output='{}'".format(output))
    ...
    def boundary_shape_complexity(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "boundary_shape_complexity", args, callback
        )  # returns 1 if error
    ...
    def find_patch_or_class_edge_cells(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "find_patch_or_class_edge_cells", args, callback
        )  # returns 1 if error
    ...
    def perimeter_area_ratio(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "perimeter_area_ratio", args, callback
        )  # returns 1 if error
    ...
    def related_circumscribing_circle(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "related_circumscribing_circle", args, callback
        )  # returns 1 if error
    ...
    def shape_complexity_index(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "shape_complexity_index", args, callback
        )  # returns 1 if error
    ...
    def shape_complexity_index_raster(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "shape_complexity_index_raster", args, callback
        )  # returns 1 if error
    ...
    def accumulation_curvature(
        self, dem, output, log=False, zfactor=1.0, callback=None
    ):
        ...
        return self.run_tool(
            "accumulation_curvature", args, callback
        )  # returns 1 if error
    ...
    def average_normal_vector_angular_deviation(
        self, dem, output, filter=11, callback=None
    ):
        ...
        args.append("--filter={}".format(filter))
        return self.run_tool(
            "average_normal_vector_angular_deviation", args, callback
        )  # returns 1 if error

    def breakline_mapping(
        self, dem, output, threshold=2.0, min_length=3, callback=None
    ):
    ...
    def circular_variance_of_aspect(self, dem, output, filter=11, callback=None):
        ...
        args.append("--filter={}".format(filter))
        return self.run_tool(
            "circular_variance_of_aspect", args, callback
        )  # returns 1 if error

    def contours_from_points(
        self,
        i,
        output,
        field=None,
        ...
        return self.run_tool(
            "contours_from_points", args, callback
        )  # returns 1 if error

    def contours_from_raster(
        self,
        i,
        output,
        interval=10.0,
        ...
        args.append("--tolerance={}".format(tolerance))
        return self.run_tool(
            "contours_from_raster", args, callback
        )  # returns 1 if error
    ...
    def diff_from_mean_elev(self, dem, output, filterx=11, filtery=11, callback=None):
        ...
        args.append("--filtery={}".format(filtery))
        return self.run_tool(
            "diff_from_mean_elev", args, callback
        )  # returns 1 if error
    ...
    def difference_curvature(self, dem, output, log=False, zfactor=1.0, callback=None):
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "difference_curvature", args, callback
        )  # returns 1 if error

    def directional_relief(
        self, dem, output, azimuth=0.0, max_dist=None, callback=None
    ):
    ...
    def edge_density(
        self, dem, output, filter=11, norm_diff=5.0, zfactor=None, callback=None
    ):
    ...
    def elev_percentile(
        self, dem, output, filterx=11, filtery=11, sig_digits=2, callback=None
    ):
    ...
    def elev_relative_to_min_max(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "elev_relative_to_min_max", args, callback
        )  # returns 1 if error

    def elev_relative_to_watershed_min_max(
        self, dem, watersheds, output, callback=None
    ):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "elev_relative_to_watershed_min_max", args, callback
        )  # returns 1 if error

    def embankment_mapping(
        self,
        dem,
        road_vec,
        output,
        ...
        if remove_embankments:
            args.append("--remove_embankments")
        return self.run_tool("embankment_mapping", args, callback)  # returns 1 if error

    def exposure_towards_wind_flux(
        self, dem, output, azimuth="", max_dist="", zfactor="", callback=None
    ):
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "exposure_towards_wind_flux", args, callback
        )  # returns 1 if error

    def feature_preserving_smoothing(
        self,
        dem,
        output,
        filter=11,
        ...
        if zfactor is not None:
            args.append("--zfactor='{}'".format(zfactor))
        return self.run_tool(
            "feature_preserving_smoothing", args, callback
        )  # returns 1 if error
    ...
    def fill_missing_data(
        self, i, output, filter=11, weight=2.0, no_edges=True, callback=None
    ):
    ...
    def gaussian_scale_space(
        ...
        return self.run_tool(
            "gaussian_scale_space", args, callback
        )  # returns 1 if error
    ...
    def generating_function(self, dem, output, log=False, zfactor=1.0, callback=None):
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "generating_function", args, callback
        )  # returns 1 if error
    ...
    def geomorphons(
        ...
        if forms:
            args.append("--forms")
        if residuals:
            args.append("--residuals")
        return self.run_tool("geomorphons", args, callback)  # returns 1 if error

    def hillshade(
        self, dem, output, azimuth=315.0, altitude=30.0, zfactor=None, callback=None
    ):
    ...
    def horizontal_excess_curvature(
        self, dem, output, log=False, zfactor=1.0, callback=None
    ):
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "horizontal_excess_curvature", args, callback
        )  # returns 1 if error
    ...
    def hypsometric_analysis(self, inputs, output, watershed=None, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "hypsometric_analysis", args, callback
        )  # returns 1 if error

    def hypsometrically_tinted_hillshade(
        self,
        dem,
        output,
        altitude=45.0,
        ...
        if zfactor is not None:
            args.append("--zfactor='{}'".format(zfactor))
        if full_mode:
            args.append("--full_mode")
        return self.run_tool(
            "hypsometrically_tinted_hillshade", args, callback
        )  # returns 1 if error

    def local_hypsometric_analysis(
        self,
        i,
        out_mag,
        out_scale,
        ...
        return self.run_tool(
            "local_hypsometric_analysis", args, callback
        )  # returns 1 if error
    ...
    def local_quadratic_regression(self, dem, output, filter=3, callback=None):
        ...
        args.append("--filter={}".format(filter))
        return self.run_tool(
            "local_quadratic_regression", args, callback
        )  # returns 1 if error

    def map_off_terrain_objects(
        self, dem, output, max_slope=40.0, min_size=1, callback=None
    ):
        ...
        return self.run_tool(
            "map_off_terrain_objects", args, callback
        )  # returns 1 if error

    def max_anisotropy_dev(
        self, dem, out_mag, out_scale, max_scale, min_scale=3, step=2, callback=None
    ):
    ...
    def max_anisotropy_dev_signature(
        self, dem, points, output, max_scale, min_scale=1, step=1, callback=None
    ):
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "max_anisotropy_dev_signature", args, callback
        )  # returns 1 if error
    ...
    def max_difference_from_mean(
        self, dem, out_mag, out_scale, min_scale, max_scale, step=1, callback=None
    ):
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "max_difference_from_mean", args, callback
        )  # returns 1 if error
    ...
    def max_downslope_elev_change(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "max_downslope_elev_change", args, callback
        )  # returns 1 if error

    def max_elev_dev_signature(
        self, dem, points, output, min_scale, max_scale, step=10, callback=None
    ):
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "max_elev_dev_signature", args, callback
        )  # returns 1 if error
    ...
    def max_elevation_deviation(
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "max_elevation_deviation", args, callback
        )  # returns 1 if error
    ...
    def max_upslope_elev_change(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "max_upslope_elev_change", args, callback
        )  # returns 1 if error
    ...
    def min_downslope_elev_change(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "min_downslope_elev_change", args, callback
        )  # returns 1 if error
    ...
    def multidirectional_hillshade(
        self, dem, output, altitude=45.0, zfactor=None, full_mode=False, callback=None
    ):
        ...
        if full_mode:
            args.append("--full_mode")
        return self.run_tool(
            "multidirectional_hillshade", args, callback
        )  # returns 1 if error

    def multiscale_curvatures(
        self,
        dem,
        out_mag,
        ...
        return self.run_tool(
            "multiscale_curvatures", args, callback
        )  # returns 1 if error

    def multiscale_elevation_percentile(
        self,
        dem,
        out_mag,
        out_scale,
        ...
        args.append("--step_nonlinearity={}".format(step_nonlinearity))
        return self.run_tool(
            "multiscale_elevation_percentile", args, callback
        )  # returns 1 if error

    def multiscale_roughness(
        self, dem, out_mag, out_scale, max_scale, min_scale=1, step=1, callback=None
    ):
        """Calculates surface roughness over a range of spatial scales.
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "multiscale_roughness", args, callback
        )  # returns 1 if error

    def multiscale_roughness_signature(
        self, dem, points, output, max_scale, min_scale=1, step=1, callback=None
    ):
        ...
        args.append("--step={}".format(step))
        return self.run_tool(
            "multiscale_roughness_signature", args, callback
        )  # returns 1 if error

    def multiscale_std_dev_normals(
        self,
        dem,
        out_mag,
        out_scale,
        ...
        args.append("--step_nonlinearity={}".format(step_nonlinearity))
        return self.run_tool(
            "multiscale_std_dev_normals", args, callback
        )  # returns 1 if error

    def multiscale_std_dev_normals_signature(
        self,
        dem,
        points,
        output,
        ...
        args.append("--step_nonlinearity={}".format(step_nonlinearity))
        return self.run_tool(
            "multiscale_std_dev_normals_signature", args, callback
        )  # returns 1 if error

    def multiscale_topographic_position_image(
        self, local, meso, broad, output, hillshade=None, lightness=1.2, callback=None
    ):
        ...
        if hillshade is not None:
            args.append("--hillshade='{}'".format(hillshade))
        args.append("--output='{}'".format(output))
        args.append("--lightness={}".format(lightness))
        return self.run_tool(
            "multiscale_topographic_position_image", args, callback
        )  # returns 1 if error
    ...
    def num_downslope_neighbours(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "num_downslope_neighbours", args, callback
        )  # returns 1 if error
    ...
    def num_upslope_neighbours(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "num_upslope_neighbours", args, callback
        )  # returns 1 if error
    ...
    def pennock_landform_class(
        self, dem, output, slope=3.0, prof=0.1, plan=0.0, zfactor=None, callback=None
    ):
        ...
        if zfactor is not None:
            args.append("--zfactor='{}'".format(zfactor))
        return self.run_tool(
            "pennock_landform_class", args, callback
        )  # returns 1 if error
    ...
    def relative_topographic_position(
        self, dem, output, filterx=11, filtery=11, callback=None
    ):
        ...
        args.append("--filtery={}".format(filtery))
        return self.run_tool(
            "relative_topographic_position", args, callback
        )  # returns 1 if error

    def remove_off_terrain_objects(
        self, dem, output, filter=11, slope=15.0, callback=None
    ):
        ...
        args.append("--slope={}".format(slope))
        return self.run_tool(
            "remove_off_terrain_objects", args, callback
        )  # returns 1 if error
    ...
    def sediment_transport_index(
        self, sca, slope, output, sca_exponent=0.4, slope_exponent=1.3, callback=None
    ):
        ...
        return self.run_tool(
            "sediment_transport_index", args, callback
        )  # returns 1 if error

    def shadow_animation(
        self,
        i,
        output,
        palette="atlas",
    ...
    def slope_vs_aspect_plot(
        self, i, output, bin_size=2.0, min_slope=0.1, zfactor=1.0, callback=None
    ):
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "slope_vs_aspect_plot", args, callback
        )  # returns 1 if error
    ...
    def slope_vs_elevation_plot(self, inputs, output, watershed=None, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "slope_vs_elevation_plot", args, callback
        )  # returns 1 if error

    def smooth_vegetation_residual(
        self,
        i,
        output,
        max_scale=30,
        ...
        return self.run_tool(
            "smooth_vegetation_residual", args, callback
        )  # returns 1 if error
    ...
    def spherical_std_dev_of_normals(self, dem, output, filter=11, callback=None):
        ...
        args.append("--filter={}".format(filter))
        return self.run_tool(
            "spherical_std_dev_of_normals", args, callback
        )  # returns 1 if error

    def standard_deviation_of_slope(
        self, i, output, zfactor=None, filterx=11, filtery=11, callback=None
    ):
        ...
        args.append("--filtery={}".format(filtery))
        return self.run_tool(
            "standard_deviation_of_slope", args, callback
        )  # returns 1 if error
    ...
    def tangential_curvature(self, dem, output, log=False, zfactor=None, callback=None):
        ...
        if zfactor is not None:
            args.append("--zfactor='{}'".format(zfactor))
        return self.run_tool(
            "tangential_curvature", args, callback
        )  # returns 1 if error

    def time_in_daylight(
        self,
        dem,
        output,
        lat,
    ...
    def topographic_position_animation(
        self,
        i,
        output,
        palette="bl_yl_rd",
        ...
        if dev_max:
            args.append("--dev_max")
        return self.run_tool(
            "topographic_position_animation", args, callback
        )  # returns 1 if error
    ...
    def vertical_excess_curvature(
        ...
        args.append("--zfactor={}".format(zfactor))
        return self.run_tool(
            "vertical_excess_curvature", args, callback
        )  # returns 1 if error
    ...
    def average_flowpath_slope(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "average_flowpath_slope", args, callback
        )  # returns 1 if error
    ...
    def average_upslope_flowpath_length(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "average_upslope_flowpath_length", args, callback
        )  # returns 1 if error
    ...
    def breach_depressions(
        ...
        if flat_increment is not None:
            args.append("--flat_increment='{}'".format(flat_increment))
        if fill_pits:
            args.append("--fill_pits")
    ...
    def breach_depressions_least_cost(
        ...
        if max_cost is not None:
            args.append("--max_cost='{}'".format(max_cost))
        if min_dist:
            args.append("--min_dist")
        if flat_increment is not None:
            args.append("--flat_increment='{}'".format(flat_increment))
        if fill:
            args.append("--fill")
        return self.run_tool(
            "breach_depressions_least_cost", args, callback
        )  # returns 1 if error
    ...
    def breach_single_cell_pits(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "breach_single_cell_pits", args, callback
        )  # returns 1 if error

    def burn_streams_at_roads(
        self, dem, streams, roads, output, width=None, callback=None
    ):
        ...
        if width is not None:
            args.append("--width='{}'".format(width))
        return self.run_tool(
            "burn_streams_at_roads", args, callback
        )  # returns 1 if error
    ...
    def d8_flow_accumulation(
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "d8_flow_accumulation", args, callback
        )  # returns 1 if error
    ...
    def d_inf_flow_accumulation(
        ...
        if pntr:
            args.append("--pntr")
        return self.run_tool(
            "d_inf_flow_accumulation", args, callback
        )  # returns 1 if error

    def d_inf_mass_flux(
        self, dem, loading, efficiency, absorption, output, callback=None
    ):
    ...
    def downslope_distance_to_stream(
        self, dem, streams, output, dinf=False, callback=None
    ):
        ...
        if dinf:
            args.append("--dinf")
        return self.run_tool(
            "downslope_distance_to_stream", args, callback
        )  # returns 1 if error
    ...
    def downslope_flowpath_length(
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "downslope_flowpath_length", args, callback
        )  # returns 1 if error

    def edge_contamination(
        self, dem, output, flow_type="mfd", zfactor="", callback=None
    ):
    ...
    def elevation_above_stream(self, dem, streams, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "elevation_above_stream", args, callback
        )  # returns 1 if error
    ...
    def elevation_above_stream_euclidean(self, dem, streams, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "elevation_above_stream_euclidean", args, callback
        )  # returns 1 if error

    def fd8_flow_accumulation(
        self,
        dem,
        output,
        out_type="specific contributing area",
        ...
        if clip:
            args.append("--clip")
        return self.run_tool(
            "fd8_flow_accumulation", args, callback
        )  # returns 1 if error
    ...
    def fill_depressions_planchon_and_darboux(
        self, dem, output, fix_flats=True, flat_increment=None, callback=None
    ):
        ...
        if flat_increment is not None:
            args.append("--flat_increment='{}'".format(flat_increment))
        return self.run_tool(
            "fill_depressions_planchon_and_darboux", args, callback
        )  # returns 1 if error

    def fill_depressions_wang_and_liu(
        self, dem, output, fix_flats=True, flat_increment=None, callback=None
    ):
        ...
        if flat_increment is not None:
            args.append("--flat_increment='{}'".format(flat_increment))
        return self.run_tool(
            "fill_depressions_wang_and_liu", args, callback
        )  # returns 1 if error
    ...
    def fill_single_cell_pits(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "fill_single_cell_pits", args, callback
        )  # returns 1 if error
    ...
    def flow_accumulation_full_workflow(
        self,
        dem,
        out_dem,
        out_pntr,
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "flow_accumulation_full_workflow", args, callback
        )  # returns 1 if error
    ...
    def hydrologic_connectivity(
        ...
        if threshold is not None:
            args.append("--threshold='{}'".format(threshold))
        return self.run_tool(
            "hydrologic_connectivity", args, callback
        )  # returns 1 if error

    def impoundment_size_index(
        self,
        dem,
        damlength,
        out_mean=None,
        ...
        if out_mean is not None:
            args.append("--out_mean='{}'".format(out_mean))
        if out_max is not None:
            args.append("--out_max='{}'".format(out_max))
        if out_volume is not None:
            args.append("--out_volume='{}'".format(out_volume))
        if out_area is not None:
            args.append("--out_area='{}'".format(out_area))
        if out_dam_height is not None:
            args.append("--out_dam_height='{}'".format(out_dam_height))
        args.append("--damlength='{}'".format(damlength))
        return self.run_tool(
            "impoundment_size_index", args, callback
        )  # returns 1 if error
    ...
    def jenson_snap_pour_points(
        self, pour_pts, streams, output, snap_dist, callback=None
    ):
        ...
        return self.run_tool(
            "jenson_snap_pour_points", args, callback
        )  # returns 1 if error
    ...
    def low_points_on_headwater_divides(self, dem, streams, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "low_points_on_headwater_divides", args, callback
        )  # returns 1 if error
    ...
    def max_upslope_flowpath_length(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "max_upslope_flowpath_length", args, callback
        )  # returns 1 if error
    ...
    def md_inf_flow_accumulation(
        ...
        if clip:
            args.append("--clip")
        return self.run_tool(
            "md_inf_flow_accumulation", args, callback
        )  # returns 1 if error
    ...
    def num_inflowing_neighbours(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "num_inflowing_neighbours", args, callback
        )  # returns 1 if error

    def qin_flow_accumulation(
        self,
        dem,
        output,
        out_type="specific contributing area",
        ...
        if clip:
            args.append("--clip")
        return self.run_tool(
            "qin_flow_accumulation", args, callback
        )  # returns 1 if error

    def quinn_flow_accumulation(
        self,
        dem,
        output,
        out_type="specific contributing area",
        ...
        if clip:
            args.append("--clip")
        return self.run_tool(
            "quinn_flow_accumulation", args, callback
        )  # returns 1 if error
    ...
    def rho8_flow_accumulation(
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "rho8_flow_accumulation", args, callback
        )  # returns 1 if error
    ...
    def stochastic_depression_analysis(
        self, dem, output, rmse, range, iterations=100, callback=None
    ):
        ...
        return self.run_tool(
            "stochastic_depression_analysis", args, callback
        )  # returns 1 if error

    def strahler_order_basins(
        self, d8_pntr, streams, output, esri_pntr=False, callback=None
    ):
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "strahler_order_basins", args, callback
        )  # returns 1 if error
    ...
    def trace_downslope_flowpaths(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "trace_downslope_flowpaths", args, callback
        )  # returns 1 if error
    ...
    def upslope_depression_storage(self, dem, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "upslope_depression_storage", args, callback
        )  # returns 1 if error
    ...
    def change_vector_analysis(self, date1, date2, magnitude, direction, callback=None):
        ...
        return self.run_tool(
            "change_vector_analysis", args, callback
        )  # returns 1 if error
    ...
    def create_colour_composite(
        ...
        if zeros:
            args.append("--zeros")
        return self.run_tool(
            "create_colour_composite", args, callback
        )  # returns 1 if error
    ...
    def image_stack_profile(self, inputs, points, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "image_stack_profile", args, callback
        )  # returns 1 if error
    ...
    def mosaic_with_feathering(
        self, input1, input2, output, method="cc", weight=4.0, callback=None
    ):
        ...
        args.append("--weight={}".format(weight))
        return self.run_tool(
            "mosaic_with_feathering", args, callback
        )  # returns 1 if error

    def normalized_difference_index(
        self, input1, input2, output, clip=0.0, correction=0.0, callback=None
    ):
        ...
        return self.run_tool(
            "normalized_difference_index", args, callback
        )  # returns 1 if error
    ...
    def resample(
        self, inputs, output, cell_size=None, base=None, method="cc", callback=None
    ):
    ...
    def split_colour_composite(self, i, red=None, green=None, blue=None, callback=None):
        ...
        if blue is not None:
            args.append("--blue='{}'".format(blue))
        return self.run_tool(
            "split_colour_composite", args, callback
        )  # returns 1 if error
    ...
    def thicken_raster_line(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "thicken_raster_line", args, callback
        )  # returns 1 if error

    def tophat_transform(
        self, i, output, filterx=11, filtery=11, variant="white", callback=None
    ):
    ...
    def write_function_memory_insertion(
        self, input1, input2, output, input3=None, callback=None
    ):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "write_function_memory_insertion", args, callback
        )  # returns 1 if error
    ...
    def evaluate_training_sites(self, inputs, polys, field, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "evaluate_training_sites", args, callback
        )  # returns 1 if error

    def generalize_classified_raster(
        self, i, output, min_size=4, method="longest", callback=None
    ):
        ...
        args.append("--method={}".format(method))
        return self.run_tool(
            "generalize_classified_raster", args, callback
        )  # returns 1 if error

    def generalize_with_similarity(
        self, i, similarity, output, min_size=4, callback=None
    ):
        ...
        args.append("--min_size={}".format(min_size))
        return self.run_tool(
            "generalize_with_similarity", args, callback
        )  # returns 1 if error

    def image_segmentation(
        self, inputs, output, threshold=0.5, steps=10, min_area=4, callback=None
    ):
    ...
    def min_dist_classification(
        self, inputs, polys, field, output, threshold=None, callback=None
    ):
        ...
        if threshold is not None:
            args.append("--threshold='{}'".format(threshold))
        return self.run_tool(
            "min_dist_classification", args, callback
        )  # returns 1 if error

    def parallelepiped_classification(
        self, inputs, polys, field, output, callback=None
    ):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "parallelepiped_classification", args, callback
        )  # returns 1 if error
    ...
    def adaptive_filter(
        self, i, output, filterx=11, filtery=11, threshold=2.0, callback=None
    ):
    ...
    def bilateral_filter(
        self, i, output, sigma_dist=0.75, sigma_int=1.0, callback=None
    ):
    ...
    def canny_edge_detection(
        self, i, output, sigma=0.5, low=0.05, high=0.15, add_back=False, callback=None
    ):
        ...
        if add_back:
            args.append("--add_back")
        return self.run_tool(
            "canny_edge_detection", args, callback
        )  # returns 1 if error

    def conservative_smoothing_filter(
        self, i, output, filterx=3, filtery=3, callback=None
    ):
        ...
        args.append("--filtery={}".format(filtery))
        return self.run_tool(
            "conservative_smoothing_filter", args, callback
        )  # returns 1 if error
    ...
    def diff_of_gaussian_filter(self, i, output, sigma1=2.0, sigma2=4.0, callback=None):
        ...
        return self.run_tool(
            "diff_of_gaussian_filter", args, callback
        )  # returns 1 if error
    ...
    def edge_preserving_mean_filter(
        self, i, output, threshold, filter=11, callback=None
    ):
        ...
        args.append("--threshold='{}'".format(threshold))
        return self.run_tool(
            "edge_preserving_mean_filter", args, callback
        )  # returns 1 if error
    ...
    def fast_almost_gaussian_filter(self, i, output, sigma=1.8, callback=None):
        ...
        args.append("--sigma={}".format(sigma))
        return self.run_tool(
            "fast_almost_gaussian_filter", args, callback
        )  # returns 1 if error
    ...
    def high_pass_bilateral_filter(
        self, i, output, sigma_dist=0.75, sigma_int=1.0, callback=None
    ):
        ...
        args.append("--sigma_int={}".format(sigma_int))
        return self.run_tool(
            "high_pass_bilateral_filter", args, callback
        )  # returns 1 if error
    ...
    def high_pass_median_filter(
        self, i, output, filterx=11, filtery=11, sig_digits=2, callback=None
    ):
        ...
        args.append("--sig_digits={}".format(sig_digits))
        return self.run_tool(
            "high_pass_median_filter", args, callback
        )  # returns 1 if error

    def k_nearest_mean_filter(
        self, i, output, filterx=11, filtery=11, k=5, callback=None
    ):
        ...
        return self.run_tool(
            "k_nearest_mean_filter", args, callback
        )  # returns 1 if error
    ...
    def laplacian_of_gaussian_filter(self, i, output, sigma=0.75, callback=None):
        ...
        args.append("--sigma={}".format(sigma))
        return self.run_tool(
            "laplacian_of_gaussian_filter", args, callback
        )  # returns 1 if error

    def lee_sigma_filter(
        self, i, output, filterx=11, filtery=11, sigma=10.0, m=5.0, callback=None
    ):
    ...
    def line_detection_filter(
        self, i, output, variant="vertical", absvals=False, clip=0.0, callback=None
    ):
        ...
        args.append("--clip={}".format(clip))
        return self.run_tool(
            "line_detection_filter", args, callback
        )  # returns 1 if error
    ...
    def roberts_cross_filter(self, i, output, clip=0.0, callback=None):
        ...
        args.append("--clip={}".format(clip))
        return self.run_tool(
            "roberts_cross_filter", args, callback
        )  # returns 1 if error
    ...
    def standard_deviation_filter(
        ...
        args.append("--filtery={}".format(filtery))
        return self.run_tool(
            "standard_deviation_filter", args, callback
        )  # returns 1 if error
    ...
    def unsharp_masking(
        self, i, output, sigma=0.75, amount=100.0, threshold=0.0, callback=None
    ):
    ...
    def user_defined_weights_filter(
        self, i, weights, output, center="center", normalize=False, callback=None
    ):
        ...
        return self.run_tool(
            "user_defined_weights_filter", args, callback
        )  # returns 1 if error
    ...
    def balance_contrast_enhancement(self, i, output, band_mean=100.0, callback=None):
        ...
        return self.run_tool(
            "balance_contrast_enhancement", args, callback
        )  # returns 1 if error

    def correct_vignetting(
        self, i, pp, output, focal_length=304.8, image_width=228.6, n=4.0, callback=None
    ):
    ...
    def direct_decorrelation_stretch(self, i, output, k=0.5, clip=1.0, callback=None):
        ...
        args.append("--clip={}".format(clip))
        return self.run_tool(
            "direct_decorrelation_stretch", args, callback
        )  # returns 1 if error
    ...
    def gaussian_contrast_stretch(self, i, output, num_tones=256, callback=None):
        ...
        return self.run_tool(
            "gaussian_contrast_stretch", args, callback
        )  # returns 1 if error
    ...
    def histogram_equalization(self, i, output, num_tones=256, callback=None):
        ...
        args.append("--num_tones={}".format(num_tones))
        return self.run_tool(
            "histogram_equalization", args, callback
        )  # returns 1 if error
    ...
    def histogram_matching_two_images(self, input1, input2, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "histogram_matching_two_images", args, callback
        )  # returns 1 if error

    def min_max_contrast_stretch(
        self, i, output, min_val, max_val, num_tones=256, callback=None
    ):
        ...
        args.append("--num_tones={}".format(num_tones))
        return self.run_tool(
            "min_max_contrast_stretch", args, callback
        )  # returns 1 if error

    def panchromatic_sharpening(
        self,
        pan,
        output,
        red=None,
        ...
        args.append("--method={}".format(method))
        return self.run_tool(
            "panchromatic_sharpening", args, callback
        )  # returns 1 if error

    def percentage_contrast_stretch(
        self, i, output, clip=1.0, tail="both", num_tones=256, callback=None
    ):
        ...
        args.append("--num_tones={}".format(num_tones))
        return self.run_tool(
            "percentage_contrast_stretch", args, callback
        )  # returns 1 if error

    def piecewise_contrast_stretch(
        self, i, output, function="", greytones=1024, callback=None
    ):
        ...
        return self.run_tool(
            "piecewise_contrast_stretch", args, callback
        )  # returns 1 if error

    def sigmoidal_contrast_stretch(
        self, i, output, cutoff=0.0, gain=1.0, num_tones=256, callback=None
    ):
        ...
        args.append("--num_tones={}".format(num_tones))
        return self.run_tool(
            "sigmoidal_contrast_stretch", args, callback
        )  # returns 1 if error

    def standard_deviation_contrast_stretch(
        self, i, output, stdev=2.0, num_tones=256, callback=None
    ):
        ...
        args.append("--num_tones={}".format(num_tones))
        return self.run_tool(
            "standard_deviation_contrast_stretch", args, callback
        )  # returns 1 if error
    ...
    def classify_buildings_in_lidar(self, i, buildings, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "classify_buildings_in_lidar", args, callback
        )  # returns 1 if error
    ...
    def classify_overlap_points(
        ...
        if filter:
            args.append("--filter")
        return self.run_tool(
            "classify_overlap_points", args, callback
        )  # returns 1 if error
    ...
    def clip_lidar_to_polygon(self, i, polygons, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "clip_lidar_to_polygon", args, callback
        )  # returns 1 if error

    def colourize_based_on_class(
        self,
        i=None,
        output=None,
        ...
        if use_unique_clrs_for_buildings:
            args.append("--use_unique_clrs_for_buildings")
        args.append("--radius={}".format(radius))
        return self.run_tool(
            "colourize_based_on_class", args, callback
        )  # returns 1 if error

    def colourize_based_on_point_returns(
        self,
        i=None,
        output=None,
        intensity_blending=50.0,
        ...
        return self.run_tool(
            "colourize_based_on_point_returns", args, callback
        )  # returns 1 if error
    ...
    def erase_polygon_from_lidar(self, i, polygons, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "erase_polygon_from_lidar", args, callback
        )  # returns 1 if error
    ...
    def filter_lidar_classes(self, i, output, exclude_cls=None, callback=None):
        ...
        return self.run_tool(
            "filter_lidar_classes", args, callback
        )  # returns 1 if error
    ...
    def filter_lidar_scan_angles(self, i, output, threshold, callback=None):
        ...
        args.append("--threshold='{}'".format(threshold))
        return self.run_tool(
            "filter_lidar_scan_angles", args, callback
        )  # returns 1 if error
    ...
    def find_flightline_edge_points(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "find_flightline_edge_points", args, callback
        )  # returns 1 if error
    ...
    def height_above_ground(self, i=None, output=None, callback=None):
        ...
        if output is not None:
            args.append("--output='{}'".format(output))
        return self.run_tool(
            "height_above_ground", args, callback
        )  # returns 1 if error

    def individual_tree_detection(
        self,
        i=None,
        output=None,
        ...
        args.append("--max_height={}".format(max_height))
        if only_use_veg:
            args.append("--only_use_veg")
        return self.run_tool(
            "individual_tree_detection", args, callback
        )  # returns 1 if error
    ...
    def las_to_multipoint_shapefile(self, i=None, callback=None):
        ...
        if i is not None:
            args.append("--input='{}'".format(i))
        return self.run_tool(
            "las_to_multipoint_shapefile", args, callback
        )  # returns 1 if error
    ...
    def las_to_zlidar(
        self, inputs=None, outdir=None, compress="brotli", level=5, callback=None
    ):
    ...
    def lidar_block_maximum(self, i=None, output=None, resolution=1.0, callback=None):
        ...
        args.append("--resolution={}".format(resolution))
        return self.run_tool(
            "lidar_block_maximum", args, callback
        )  # returns 1 if error
    ...
    def lidar_block_minimum(self, i=None, output=None, resolution=1.0, callback=None):
        ...
        args.append("--resolution={}".format(resolution))
        return self.run_tool(
            "lidar_block_minimum", args, callback
        )  # returns 1 if error

    def lidar_classify_subset(
        self, base, subset, output, subset_class, nonsubset_class=None, callback=None
    ):
        ...
        if nonsubset_class is not None:
            args.append("--nonsubset_class='{}'".format(nonsubset_class))
        return self.run_tool(
            "lidar_classify_subset", args, callback
        )  # returns 1 if error
    ...
    def lidar_digital_surface_model(
        self,
        i=None,
        output=None,
        resolution=1.0,
        ...
        return self.run_tool(
            "lidar_digital_surface_model", args, callback
        )  # returns 1 if error

    def lidar_eigenvalue_features(
        self, i=None, num_neighbours=None, radius=None, callback=None
    ):
        ...
        if num_neighbours is not None:
            args.append("--num_neighbours='{}'".format(num_neighbours))
        if radius is not None:
            args.append("--radius='{}'".format(radius))
        return self.run_tool(
            "lidar_eigenvalue_features", args, callback
        )  # returns 1 if error

    def lidar_elevation_slice(
        self,
        i,
        output,
        minz=None,
        ...
        return self.run_tool(
            "lidar_elevation_slice", args, callback
        )  # returns 1 if error

    def lidar_ground_point_filter(
        self,
        i,
        output,
        radius=2.0,
        ...
        if slope_norm:
            args.append("--slope_norm")
        if height_above_ground:
            args.append("--height_above_ground")
        return self.run_tool(
            "lidar_ground_point_filter", args, callback
        )  # returns 1 if error

    def lidar_hex_binning(
        self, i, output, width, orientation="horizontal", callback=None
    ):
    ...
    def lidar_hillshade(
        self, i, output, azimuth=315.0, altitude=30.0, radius=1.0, callback=None
    ):
    ...
    def lidar_histogram(
        self, i, output, parameter="elevation", clip=1.0, callback=None
    ):
    ...
    def lidar_idw_interpolation(
        ...
        if maxz is not None:
            args.append("--maxz='{}'".format(maxz))
        return self.run_tool(
            "lidar_idw_interpolation", args, callback
        )  # returns 1 if error

    def lidar_info(
        self, i, output, density=True, vlr=True, geokeys=True, callback=None
    ):
    ...
    def lidar_kappa_index(
        self, input1, input2, output, class_accuracy, resolution=1.0, callback=None
    ):
    ...
    def lidar_nearest_neighbour_gridding(
        self,
        i=None,
        output=None,
        parameter="elevation",
        ...
        if maxz is not None:
            args.append("--maxz='{}'".format(maxz))
        return self.run_tool(
            "lidar_nearest_neighbour_gridding", args, callback
        )  # returns 1 if error

    def lidar_point_density(
        self,
        i=None,
        output=None,
        returns="all",
        ...
        if maxz is not None:
            args.append("--maxz='{}'".format(maxz))
        return self.run_tool(
            "lidar_point_density", args, callback
        )  # returns 1 if error
    ...
    def lidar_point_return_analysis(self, i, output=None, callback=None):
        ...
        if output is not None:
            args.append("--output='{}'".format(output))
        return self.run_tool(
            "lidar_point_return_analysis", args, callback
        )  # returns 1 if error

    def lidar_point_stats(
        self,
        i=None,
        resolution=1.0,
        num_points=True,
    ...
    def lidar_ransac_planes(
        ...
        if classify:
            args.append("--classify")
        if last_returns:
            args.append("--last_returns")
        return self.run_tool(
            "lidar_ransac_planes", args, callback
        )  # returns 1 if error

    def lidar_rbf_interpolation(
        self,
        i=None,
        output=None,
        parameter="elevation",
        ...
        args.append("--weight={}".format(weight))
        return self.run_tool(
            "lidar_rbf_interpolation", args, callback
        )  # returns 1 if error
    ...
    def lidar_remove_duplicates(self, i, output, include_z=False, callback=None):
        ...
        return self.run_tool(
            "lidar_remove_duplicates", args, callback
        )  # returns 1 if error

    def lidar_remove_outliers(
        self,
        i,
        output,
        radius=2.0,
        ...
        if classify:
            args.append("--classify")
        return self.run_tool(
            "lidar_remove_outliers", args, callback
        )  # returns 1 if error

    def lidar_rooftop_analysis(
        self,
        buildings,
        output,
        i=None,
        ...
        args.append("--altitude={}".format(altitude))
        return self.run_tool(
            "lidar_rooftop_analysis", args, callback
        )  # returns 1 if error
    ...
    def lidar_segmentation_based_filter(
        self,
        i,
        output,
        radius=5.0,
        ...
        if classify:
            args.append("--classify")
        return self.run_tool(
            "lidar_segmentation_based_filter", args, callback
        )  # returns 1 if error
    ...
    def lidar_sibson_interpolation(
        self,
        i=None,
        output=None,
        parameter="elevation",
        ...
        if maxz is not None:
            args.append("--maxz='{}'".format(maxz))
        return self.run_tool(
            "lidar_sibson_interpolation", args, callback
        )  # returns 1 if error
    ...
    def lidar_thin(
        ...
        args.append("--method={}".format(method))
        if save_filtered:
            args.append("--save_filtered")
        return self.run_tool("lidar_thin", args, callback)  # returns 1 if error

    def lidar_thin_high_density(
        self, i, output, density, resolution=1.0, save_filtered=False, callback=None
    ):
        ...
        if save_filtered:
            args.append("--save_filtered")
        return self.run_tool(
            "lidar_thin_high_density", args, callback
        )  # returns 1 if error
    ...
    def lidar_tile_footprint(self, output, i=None, hull=False, callback=None):
        ...
        if hull:
            args.append("--hull")
        return self.run_tool(
            "lidar_tile_footprint", args, callback
        )  # returns 1 if error

    def lidar_tin_gridding(
        self,
        i=None,
        output=None,
        parameter="elevation",
    ...
    def lidar_tophat_transform(self, i, output, radius=1.0, callback=None):
        ...
        args.append("--radius={}".format(radius))
        return self.run_tool(
            "lidar_tophat_transform", args, callback
        )  # returns 1 if error
    ...
    def recover_flightline_info(
        ...
        if pt_src_id:
            args.append("--pt_src_id")
        if user_data:
            args.append("--user_data")
        if rgb:
            args.append("--rgb")
        return self.run_tool(
            "recover_flightline_info", args, callback
        )  # returns 1 if error
    ...
    def select_tiles_by_polygon(self, indir, outdir, polygons, callback=None):
        ...
        args.append("--polygons='{}'".format(polygons))
        return self.run_tool(
            "select_tiles_by_polygon", args, callback
        )  # returns 1 if error
    ...
    def split_lidar(
        self, i=None, criterion="num_pts", interval="", min_pts=5, callback=None
    ):
    ...
    def logistic_regression(
        ...
        args.append("--test_proportion={}".format(test_proportion))
        return self.run_tool(
            "logistic_regression", args, callback
        )  # returns 1 if error

    def modified_k_means_clustering(
        self,
        inputs,
        output,
        out_html=None,
        ...
        if merge_dist is not None:
            args.append("--merge_dist='{}'".format(merge_dist))
        args.append("--max_iterations={}".format(max_iterations))
        args.append("--class_change={}".format(class_change))
        return self.run_tool(
            "modified_k_means_clustering", args, callback
        )  # returns 1 if error
    ...
    def random_forest_classification(
        ...
        args.append("--test_proportion={}".format(test_proportion))
        return self.run_tool(
            "random_forest_classification", args, callback
        )  # returns 1 if error
    ...
    def random_forest_regression(
        ...
        args.append("--test_proportion={}".format(test_proportion))
        return self.run_tool(
            "random_forest_regression", args, callback
        )  # returns 1 if error
    ...
    def attribute_correlation(self, i, output=None, callback=None):
        ...
        if output is not None:
            args.append("--output='{}'".format(output))
        return self.run_tool(
            "attribute_correlation", args, callback
        )  # returns 1 if error

    def attribute_correlation_neighbourhood_analysis(
        self,
        i,
        field1,
        field2,
        ...
        return self.run_tool(
            "attribute_correlation_neighbourhood_analysis", args, callback
        )  # returns 1 if error
    ...
    def attribute_histogram(self, i, field, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "attribute_histogram", args, callback
        )  # returns 1 if error

    def attribute_scattergram(
        self, i, fieldx, fieldy, output, trendline=False, callback=None
    ):
        ...
        args.append("--output='{}'".format(output))
        if trendline:
            args.append("--trendline")
        return self.run_tool(
            "attribute_scattergram", args, callback
        )  # returns 1 if error
    ...
    def conditional_evaluation(
        self, i, output, statement="", true=None, false=None, callback=None
    ):
        ...
        args.append("--statement={}".format(statement))
        if true is not None:
            args.append("--true='{}'".format(true))
        if false is not None:
            args.append("--false='{}'".format(false))
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "conditional_evaluation", args, callback
        )  # returns 1 if error

    def conditioned_latin_hypercube(
        self,
        inputs,
        output,
        samples=500,
        ...
        if average:
            args.append("--average")
        return self.run_tool(
            "conditioned_latin_hypercube", args, callback
        )  # returns 1 if error
    ...
    def cumulative_distribution(self, i, output, callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "cumulative_distribution", args, callback
        )  # returns 1 if error
    ...
    def image_autocorrelation(self, inputs, output, contiguity="Rook", callback=None):
        ...
        args.append("--output='{}'".format(output))
        return self.run_tool(
            "image_autocorrelation", args, callback
        )  # returns 1 if error
    ...
    def image_correlation_neighbourhood_analysis(
        self, input1, input2, output1, output2, filter=11, stat="pearson", callback=None
    ):
        ...
        args.append("--stat={}".format(stat))
        return self.run_tool(
            "image_correlation_neighbourhood_analysis", args, callback
        )  # returns 1 if error
    ...
    def image_regression(
        ...
        args.append("--input2='{}'".format(input2))
        args.append("--output='{}'".format(output))
        if out_residuals is not None:
            args.append("--out_residuals='{}'".format(out_residuals))
        if standardize:
            args.append("--standardize")
        if scattergram:
            args.append("--scattergram")
        args.append("--num_samples={}".format(num_samples))
    ...
    def inverse_principal_component_analysis(self, inputs, report, callback=None):
        ...
        return self.run_tool(
            "inverse_principal_component_analysis", args, callback
        )  # returns 1 if error
    ...
    def ks_test_for_normality(self, i, output, num_samples=None, callback=None):
        ...
        if num_samples is not None:
            args.append("--num_samples='{}'".format(num_samples))
        return self.run_tool(
            "ks_test_for_normality", args, callback
        )  # returns 1 if error
    ...
    def list_unique_values_raster(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "list_unique_values_raster", args, callback
        )  # returns 1 if error
    ...
    def paired_sample_t_test(
        self, input1, input2, output, num_samples=None, callback=None
    ):
        ...
        if num_samples is not None:
            args.append("--num_samples='{}'".format(num_samples))
        return self.run_tool(
            "paired_sample_t_test", args, callback
        )  # returns 1 if error
    ...
    def principal_component_analysis(
        self, inputs, output, num_comp=None, standardized=False, callback=None
    ):
        ...
        if num_comp is not None:
            args.append("--num_comp='{}'".format(num_comp))
        if standardized:
            args.append("--standardized")
        return self.run_tool(
            "principal_component_analysis", args, callback
        )  # returns 1 if error
    ...
    def raster_summary_stats(self, i, callback=None):
        ...
        args.append("--input='{}'".format(i))
        return self.run_tool(
            "raster_summary_stats", args, callback
        )  # returns 1 if error
    ...
    def rescale_value_range(
        ...
        return self.run_tool(
            "rescale_value_range", args, callback
        )  # returns 1 if error
    ...
    def root_mean_square_error(self, i, base, callback=None):
        ...
        args.append("--base='{}'".format(base))
        return self.run_tool(
            "root_mean_square_error", args, callback
        )  # returns 1 if error
    ...
    def trend_surface_vector_points(
        self, i, field, output, cell_size, order=1, callback=None
    ):
        ...
        args.append("--cell_size='{}'".format(cell_size))
        return self.run_tool(
            "trend_surface_vector_points", args, callback
        )  # returns 1 if error
    ...
    def turning_bands_simulation(
        self, base, output, range, iterations=1000, callback=None
    ):
        ...
        args.append("--iterations={}".format(iterations))
        return self.run_tool(
            "turning_bands_simulation", args, callback
        )  # returns 1 if error
    ...
    def wilcoxon_signed_rank_test(
        ...
        if num_samples is not None:
            args.append("--num_samples='{}'".format(num_samples))
        return self.run_tool(
            "wilcoxon_signed_rank_test", args, callback
        )  # returns 1 if error
    ...
    def zonal_statistics(
        self, i, features, output=None, stat="mean", out_table=None, callback=None
    ):
    ...
    def reconcile_multiple_headers(
        self,
        i,
        region_field,
        yield_field,
        ...
        if mean_tonnage is not None:
            args.append("--mean_tonnage='{}'".format(mean_tonnage))
        return self.run_tool(
            "reconcile_multiple_headers", args, callback
        )  # returns 1 if error

    def recreate_pass_lines(
        self,
        i,
        yield_field_name,
        output_lines,
        ...
        if ignore_zeros:
            args.append("--ignore_zeros")
        return self.run_tool(
            "recreate_pass_lines", args, callback
        )  # returns 1 if error

    def remove_field_edge_points(
        self,
        i,
        output,
        dist=None,
        ...
        args.append("--max_change_in_heading={}".format(max_change_in_heading))
        if flag_edges:
            args.append("--flag_edges")
        return self.run_tool(
            "remove_field_edge_points", args, callback
        )  # returns 1 if error
    ...
    def yield_normalization(
        ...
        args.append("--max_yield={}".format(max_yield))
        return self.run_tool(
            "yield_normalization", args, callback
        )  # returns 1 if error
    ...
    def extract_streams(
        self, flow_accum, output, threshold, zero_background=False, callback=None
    ):
    ...
    def extract_valleys(
        self, dem, output, variant="LQ", line_thin=True, filter=5, callback=None
    ):
    ...
    def farthest_channel_head(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "farthest_channel_head", args, callback
        )  # returns 1 if error
    ...
    def horton_stream_order(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "horton_stream_order", args, callback
        )  # returns 1 if error

    def length_of_upstream_channels(
        self,
        d8_pntr,
        streams,
        output,
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "length_of_upstream_channels", args, callback
        )  # returns 1 if error

    def long_profile(
        self, d8_pntr, streams, dem, output, esri_pntr=False, callback=None
    ):
    ...
    def long_profile_from_points(
        self, d8_pntr, points, dem, output, esri_pntr=False, callback=None
    ):
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "long_profile_from_points", args, callback
        )  # returns 1 if error

    def raster_streams_to_vector(
        self, streams, d8_pntr, output, esri_pntr=False, callback=None
    ):
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "raster_streams_to_vector", args, callback
        )  # returns 1 if error

    def rasterize_streams(
        self, streams, base, output, nodata=True, feature_id=False, callback=None
    ):
    ...
    def remove_short_streams(
        self, d8_pntr, streams, output, min_length, esri_pntr=False, callback=None
    ):
        ...
        if esri_pntr:
            args.append("--esri_pntr")
        return self.run_tool(
            "remove_short_streams", args, callback
        )  # returns 1 if error
    ...
    def repair_stream_vector_topology(self, i, output, dist="", callback=None):
        ...
        args.append("--dist={}".format(dist))
        return self.run_tool(
            "repair_stream_vector_topology", args, callback
        )  # returns 1 if error

    def shreve_stream_magnitude(
        self,
        d8_pntr,
        streams,
        output,
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "shreve_stream_magnitude", args, callback
        )  # returns 1 if error
    ...
    def strahler_stream_order(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "strahler_stream_order", args, callback
        )  # returns 1 if error
    ...
    def stream_link_identifier(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "stream_link_identifier", args, callback
        )  # returns 1 if error
    ...
    def stream_slope_continuous(
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "stream_slope_continuous", args, callback
        )  # returns 1 if error

    def topological_stream_order(
        self,
        d8_pntr,
        streams,
        output,
        ...
        if zero_background:
            args.append("--zero_background")
        return self.run_tool(
            "topological_stream_order", args, callback
        )  # returns 1 if error

    def tributary_identifier(
        self,
        d8_pntr,
        streams,
        output,
    ...
    def vector_stream_network_analysis(self, streams, output, snap=0.1, callback=None):
        ...
        args.append("--snap={}".format(snap))
        return self.run_tool(
            "vector_stream_network_analysis", args, callback
        )  # returns 1 if error
    ...
    def install_wb_extension(
        self, install_extension="General Toolset Extension", callback=None
    ):
        ...
        return self.run_tool(
            "install_wb_extension", args, callback
        )  # returns 1 if error
